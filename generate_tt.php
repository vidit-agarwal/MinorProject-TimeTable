					...
					if(isset($_POST['submit'])){
						...
						while($row = mysqli_fetch_assoc($query))
						{
						    ...
						    if($dep =="IT"){
						    	echo '<script type="text/javascript">
                  						alert("it") ;
                    					  window.location="choice_fill/choice_fill_it.php";
                 					   </script> ';
						    } 
...
<div class="header">
			<div>Generate <br> <span><b>Time Table</b></span></div>
</div>
		...
		<div class="login">
				...
				<div class="dept">
					...
					<input type="submit" value="Next" name="submit" onclick="redirect()" >
			...
			<script>
					...
					function redirect(){
						window.location="generate/it_tt.php" ;	
					}
			</script>
		</div>
